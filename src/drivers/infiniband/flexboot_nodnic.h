...
struct flexboot_nodnic_callbacks {
	...
	void ( * get_settings ) ( struct flexboot_nodnic *priv, void *drv_priv );
	int ( * tlv_write_fn ) ( mlx_utils *utils,
			struct driver_tlv_header *tlv_hdr );
	int ( * tlv_read_fn ) ( mlx_utils *utils,
			struct driver_tlv_header *tlv_hdr );
	int ( * tlv_invaidate_fn ) ( mlx_utils *utils,
			struct driver_tlv_header *tlv_hdr );
	void ( * update_settings_ops ) ( void );
};
